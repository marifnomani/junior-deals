                  ...
                  Container(height: 150,
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text("Sound amazing",style: TextStyle(color: Colors.grey,fontSize: 18),),
                        Text("Headphones By\nBeat",style: TextStyle(color: Colors.black,fontSize: 30,fontWeight: FontWeight.bold),)
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text("£50.00 GBP",style: TextStyle(color: Colors.black,fontSize: 24,fontWeight: FontWeight.bold),),
                        SizedBox(height: 20,),
                        Padding(
